...
class ClientController extends Controller
{
    ...
    public function store(ValidationClient $request)
    {
        ...
        if ($request->input('name_document')) {
         ...
         /*auditoria: start*/Pilates::setAudit("Alta cliente id: $client->id"); /*auditoria: end*/
    ...
    public function update(ValidationClient $request)
    {
        ...
        /*auditoria: start*/Pilates::setAudit("Actualización cliente id: $id"); /*auditoria: end*/
    ...
    public function destroy(ValidationDeleteClient $request)
    {
        ...
        /*auditoria: start*/Pilates::setAudit("Baja cliente ids: ".implode(', ', $idsClients)); /*auditoria: end*/
        return $cantSuccsess <= 1 ?
            redirect('management_client')->with('success', $cantSuccsess . ' cliente eliminado con éxito')
            :
            redirect('management_client')->with('success', $cantSuccsess . ' clientes eliminados con éxito');
    }
