...
<html lang="es">
						...
						<div class="kt-login__container">
							...
							<div class="kt-login__signup">
								<div class="kt-login__head">
									<h3 class="kt-login__title">Restablecer contraseña</h3>
									<div class="kt-login__desc">Ingrese los datos para restablecer su contraseña:</div>
								</div>
								<form class="kt-form" action="{{ route('employee.password.update') }}" method="POST">
									@csrf
									<input type="hidden" name="token" value="{{ $token }}">
									<div class="input-group">
										<input class="form-control" type="text" placeholder="Email" name="email" value="{{ $email ?? old('email') }}" autocomplete="new-password">
									</div>
									<div class="input-group">
										<input class="form-control" type="password" placeholder="Nueva contraseña" name="password">
									</div>
									<div class="input-group">
										<input class="form-control" type="password" placeholder="Confirmar nueva contraseña" name="password_confirmation" autocomplete="new-password">
									</div>
								
									<div class="kt-login__actions">
										<button id="kt_login_reset_pass_submit" class="btn btn-brand btn-pill kt-login__btn-primary">Restablecer contraseña</button>&nbsp;&nbsp;
    ...
    <script>
		...
		<!-- end::Global Config -->
			...
			<script src="{{asset("assets")}}/js/reset-pass.js" type="text/javascript"></script>
